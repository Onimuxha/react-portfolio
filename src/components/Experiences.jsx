...
const Experiences = () => {
    ...
    personal: [
      {
        ...
        languages: [
          <NextJs className='w-7 h-7' />,
          <TypeScript className='w-7 h-7' />,
          <ViteJS className='w-7 h-7' />,
          <ShadcnUI className='w-7 h-7' />,
          <TailwindCSS className='w-7 h-7' />,
        ],
        isDeployed: true,
      },
  ...
  const ExperienceCard = ({ experience, index, category }) => {
    return (
      ...
      <div className='h-full relative group bg-gray-100/90 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden hover:border-gray-300 dark:hover:border-gray-500 transition-all duration-300 hover:shadow-lg hover:shadow-gray-400/10 dark:hover:shadow-gray-600/10 transform hover:scale-[1.03]'>
  ...
  return (
    <section id='experiences' className='py-20 bg-zinc-100 dark:bg-slate-900'>
