        ...
        {data.map((item, index) => (
          <div key={index} className='flex justify-start pt-10 md:gap-10 md:pt-40'>
            <div className='sticky top-40 z-40 flex max-w-xs flex-col items-center self-start md:w-full md:flex-row lg:max-w-sm'>
              <div className='absolute left-3 flex h-10 w-10 items-center justify-center rounded-full bg-zinc-100 dark:bg-slate-900 md:left-3'>
                <div className='h-4 w-4 rounded-full border border-neutral-300 bg-neutral-300 p-2 dark:border-neutral-700 dark:bg-neutral-800' />
              </div>
